...
"aarch64-linux-thread-multi-4.14.28-0-vanilla" or
	die "Errno architecture (aarch64-linux-thread-multi-4.14.28-0-vanilla) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
